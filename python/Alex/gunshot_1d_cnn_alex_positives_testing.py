...
augmented_samples = np.zeros((true_positive_samples.shape[0] * (number_of_augmentations + 1), true_positive_samples.shape[1]))
...
print("The number of true positive samples available for training is currently " + str(len(true_positive_samples)) + '.')
...
number_of_augmentations = 5
augmented_samples = np.zeros((false_positive_samples.shape[0] * (number_of_augmentations + 1), false_positive_samples.shape[1]))
...
print("The number of false positive samples available for training is currently " + str(len(false_positive_samples)) + '.')
print("The number of false positive labels available for training is currently " + str(len(false_positive_labels)) + '.')
