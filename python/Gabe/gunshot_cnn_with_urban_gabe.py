...
gunshot_sound_dir = cwd+"/REU_Data/gunshot_data/gunshot/"
...
glassbreak_sound_dir = cwd+"/REU_Data/gunshot_data/glassbreak/"
...
sound_types = pd.read_csv(cwd+"/REU_Data/train.csv")
...
urban_sound_dir = cwd+"/REU_Data/Train/"
